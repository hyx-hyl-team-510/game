...
namespace {
struct qt_meta_tag_ZN4WallE_t {};
} // unnamed namespace

template <> constexpr inline auto Wall::qt_create_metaobjectdata<qt_meta_tag_ZN4WallE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<Wall, qt_meta_tag_ZN4WallE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject Wall::staticMetaObject = { {
    QMetaObject::SuperData::link<Entity::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN4WallE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN4WallE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN4WallE_t>.metaTypes,
    nullptr
} };
...
void *Wall::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN4WallE_t>.strings))
